...
--- GELİŞLER EK ALANDA TARİH  EKLEME 
		SELECT * FROM GELISLER 
		WHERE GIRISTARIH = '2022-02-20'
		alter table GELISLER  ADD DRPAY2TARIH DATETIME

-- SEYMAYLA YAPTIGIM İLK FATURA HATASI 

			UPDATE F SET EFATURADURUM = '2'
			--SELECT EFATURADURUM, * 
			from FATBASLIK F 

			WHERE EFATURANO ='C---00065456' 

			UPDATE I SET STATUS ='18'
			--SELECT STATUS ,*
			FROM INVOICE I 
			WHERE INVOICENO ='CC---000654566'
